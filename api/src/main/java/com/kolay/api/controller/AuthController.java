...
import com.kolay.api.payload.request.LoginRequest;
import com.kolay.api.payload.request.SignupRequest;
import com.kolay.api.payload.response.JwtResponse;
...
import com.kolay.api.security.JwtUtils;
            ...
            strRoles.forEach(role -> {
                switch (role.toLowerCase()) {
                    ...
                    case "manager":
                        ...
                        break;
                    case "waiter":
                        Role waiterRole = roleRepository.findByName(Role.RoleName.WAITER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
